    ...
    <Store.Container>
      ...
      <div
        ...
        <Links.Sidebar activeClassName='onActive' to={{ pathname: `${url}/orders` }}>
          <Icon
            src={Orders}
            loader={<div style={{ marginRight: 10 }}><Skeleton height={15} width={15} /></div>}
          /><p style={{ margin: 'auto 0' }}>Orders</p>
        </Links.Sidebar>
        <Links.Sidebar activeClassName='onActive' to={{ pathname: `${url}/pages` }}>
          <Icon src={Pages} loader={<div style={{ marginRight: 10 }}><Skeleton height={15} width={15} /></div>} /><p style={{ margin: 'auto 0' }}>Pages</p>
        </Links.Sidebar>
        <Links.Sidebar activeClassName='onActive' to={{ pathname: `${url}/products` }}>
          <Icon loader={<div style={{ marginRight: 10 }}><Skeleton height={15} width={15} /></div>} src={Products} /><p style={{ margin: 'auto 0' }}>Products</p>
        </Links.Sidebar>
        <Links.Sidebar activeClassName='onActive' to={{ pathname: `${url}/settings` }}>
          <Icon loader={<div style={{ marginRight: 10 }}><Skeleton height={15} width={15} /></div>} src={Settings} /><p style={{ margin: 'auto 0' }}>Settings</p>
        </Links.Sidebar>
        <Links.Sidebar
          onClick={() => location.assign(`/merchant/dashboard/upload/${name}`)}
          to='#'>
          <Icon loader={<div style={{ marginRight: 10 }}><Skeleton height={15} width={15} /></div>} src={Upload} /><p style={{ margin: 'auto 0' }}>Upload Product</p>
        </Links.Sidebar>
        {/* <Links.Sidebar */}
        {/*   activeClassName='onActive' to={{ pathname: `${url}/coupons` }}> */}
        {/*   <Icon loader={<div style={{ marginRight: 10 }}><Skeleton height={15} width={15} /></div>} src={Coupons} /><p style={{ margin: 'auto 0' }}>Coupons</p> */}
        {/* </Links.Sidebar> */}
        <br />
        ...
        <Links.Sidebar
          ...
          >
          <Icon loader={<div style={{ marginRight: 10 }}><Skeleton height={15} width={15} /></div>} src={Features} /><p style={{ margin: 'auto 0' }}>Features</p>
        </Links.Sidebar>
      </div>
    </Store.Container>
  )
