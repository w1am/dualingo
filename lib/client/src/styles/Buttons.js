...
const COMMON_AUTHENTICATION_BUTTON = styled.button`
  border-radius: 5px;
  background: #EE5433 linear-gradient(to bottom, #EE5433, #d6472a);
  border: 1px solid #d34123;
  -webkit-background: #EE5433 linear-gradient(to bottom, #EE5433, #d6472a);
  -moz-background: #EE5433 linear-gradient(to bottom, #EE5433, #d6472a);
  color: white;
  cursor: pointer;
  font-size: 12px;
  font-weight: 600;
