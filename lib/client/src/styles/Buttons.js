...
const COMMON_AUTHENTICATION_BUTTON = styled.button`
  ...
  background: #EE5433 linear-gradient(to right, #EE5433, #d6472a);
  -webkit-background: #EE5433 linear-gradient(to right, #EE5433, #d6472a);
  -moz-background: #EE5433 linear-gradient(to right, #EE5433, #d6472a);
  color: white;
  cursor: pointer;
  font-size: 12px;
  font-weight: 600;
  ...
  &:hover {
    background: #EE5433 linear-gradient(to right, #f7674a, #d6472a);
    -webkit-background: #EE5433 linear-gradient(to right, #f7674a, #d6472a);
    -moz-background: #EE5433 linear-gradient(to right, #f7674a, #d6472a);
    transition: 0.3s linear;
  };
`
