...
import ResponsiveSearchBar from '../containers/navigations/ResponsiveSearchBar';
  ...
  return (
    <Common.Wrappers.Page style={{ minHeight: '100vh' }}>
      ...
      <Stores.Content.Wrappers.Content style={{ maxWidth: '100%', overflow: 'none' }}>
        ...
        <Stores.Content.Containers.Content conditions='authed' style={{ width: '100%', border: 0 }}>
          <ResponsiveSearchBar
            rangeObj={rangeObj}
            setRangeObj={setRangeObj}
            rating={rating}
