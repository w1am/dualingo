...
const StoreRoute = ({ component: Component, ...rest }) => (
  <Route
    ...
    render={(props) => {
      ...
      if (isAuthenticated().ok && (stores.indexOf(props.match.params.storeName) < 0)) {
...
export default () => (
  <Switch>
    ...
    <Route path='/merchant/auth/register' exact component={MerchantForm} />
    <Route path='/merchant/dashboard/upload/:storeName' component={UploadPage} />
    ...
    <Route path='/merchant/:name/product/update/description' exact component={ProductDescription} />
    <Route path='/user/orders/:overview' exact component={Overview} />
