...
export const SAVE_SETTINGS_MUTATION = gql`
  mutation($storeName: String, $delivery: Boolean, $deliveryFee: Float, $methods: String, $logo: Upload) {
    saveSettings(storeName: $storeName, delivery: $delivery, deliveryFee: $deliveryFee, methods: $methods, logo: $logo)
  }
`
