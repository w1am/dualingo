...
export const Tags = {
  ...
  Product: {
    Mutations: {
      ...
      generateKeyword: Product.GENERATE_KEYWORD
    },
    Queries: {
      ...
      getKeywords: Product.GET_KEYWORDS,
      getViews: Product.GET_VIEWS
    }
  },
  Media: {
    Mutations: {
      ...
      upload: Media.UPLOAD,
      getSignature: Media.GET_SIGNATURE
    }
  },
  Cart: {
    Mutations: {
